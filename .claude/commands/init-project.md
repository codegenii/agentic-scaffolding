...
2. Report what was filled in, and tell the user the project is ready: run `/new-feature <slug>` to start the first feature, or `/new-chore <desc>` for non-feature work.
