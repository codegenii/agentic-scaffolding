...
1. Commit on `chore/<slug>` with a `chore(<scope>): <summary>` subject — imperative, ≤ 50 chars, no trailing period, subject only, no body. `<scope>` is a short topical word, not the full slug; do not restate the slug in the subject.
