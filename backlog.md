...
## 2. Reduce Phase 7 toolchain re-runs
...
## 3. Split pr-reviewer's mechanical checks out (model bump NOT needed)
...
## 4. Delegate Phase 1 spec drafting to an opus spec-writer agent
