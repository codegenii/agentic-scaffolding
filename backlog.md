...
## 2. Scope the resume-feature test run
...
## 3. Reduce Phase 7 toolchain re-runs
...
## 4. Split pr-reviewer's mechanical checks out (model bump NOT needed)
...
## 5. Delegate Phase 1 spec drafting to an opus spec-writer agent
